"""
Django settings for cfgcdjj_367 project.
...
WSGI_APPLICATION = 'cfgcdjj_367.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cfgcdjj_367 API",
    "DESCRIPTION": "API documentation for cfgcdjj_367 App",
    "VERSION": "v1",
}
